...
import { Transaction, InstallmentStatus } from '../types.ts';
...
export const FinancialRevenuesPage: React.FC = () => {
    ...
    // Build revenue items from transactions and installments
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background-light to-gray-50 dark:from-background-dark dark:to-gray-900 flex flex-col">
                ...
                <div className="max-w-4xl mx-auto px-3 sm:px-6 py-2 sm:py-3">
                    <div className="flex items-start gap-2 sm:gap-4">
                        ...
                        <div className="text-center flex-1">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Lista detalhada de receitas</p>
                        </div>
            ...
            <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 py-6">
                ...
                {/* Total Revenue Card */}
                <div className="rounded-xl border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 p-6 mb-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-green-700 dark:text-green-300">
                                Total de Receitas ({getFilterLabel(dateFilter)})
                            </span>
                        </div>
                    ...
                    <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
                        {revenueItems.length === 0 ? (
                            <div className="p-8 text-center">
                                <Icon name="payments" className="text-5xl text-zinc-300 dark:text-zinc-700 mb-2" />
                                <p className="text-zinc-500 dark:text-zinc-400">Nenhuma receita registrada no período selecionado</p>
                            </div>
                        ) : (
                            revenueItems.map((item) => (
                                <div key={item.id} className="p-4 hover:bg-zinc-50 dark:hover:bg-zinc-900/30 transition-colors">
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                <Icon 
                                                    name={item.type === 'transaction' ? 'receipt' : 'credit_card'} 
                                                    className={`text-base ${
