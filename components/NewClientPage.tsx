                ...
                <div className="mb-4 sm:mb-8">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div className="p-2 sm:p-3 bg-primary/10 rounded-lg">
                            <Icon name="person_add" className="text-primary text-xl sm:text-2xl" />
                        </div>
                        <div>
                            <h1 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white">Novo Cliente</h1>
                            <p className="text-xs sm:text-base text-gray-600 dark:text-gray-400 mt-0.5 sm:mt-1">Cadastre um novo cliente no sistema</p>
                        </div>
                    </div>
                </div>
